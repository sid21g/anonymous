...
SQL_statements = ["DELETE FROM anon WHERE link LIKE '%http://www.nytimes.com/by/%';",
                  "DELETE FROM anon WHERE link LIKE '%https://www.axios.com/tag/mueller-investigation/%';",
                  "DELETE FROM anon WHERE link LIKE '%https://apnews.com/RogerStone%';",
                  "DELETE FROM anon WHERE link LIKE '%https://finance.yahoo.com/news/%';",
