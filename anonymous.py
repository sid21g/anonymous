...
# TODO: Alter SQLite table to include name of publication
# TODO: Extract name of publication to insert in database
...
#   insert_values = [title.text, entry_title.text, entry_link.attrib['href'], entry_content.text]
